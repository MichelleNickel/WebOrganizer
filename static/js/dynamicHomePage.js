...
// This is still the placeholder Test implementation. 
// The actual implementation should prob. access the database directly depending on the 
// Name of the widget put in
function renderHomepage() {
    const widgetContainer = document.getElementById("widgetContainer");
    widgetContainer.innerHTML = ''; // Clear existing content

    // Test Show one to do and one Week shedule
...
function createWeek() {
    ...
    // Header
    const header = document.createElement("h2");
    header.textContent = "This Week as a Test";
    section.appendChild(header);
    ...
    var cells = [
        {
            mon: "22.04. <br><br> 20:30-21:30<br> Stretching",
            tue: "23.04.",
            wed: "24.04. <br><br> 18:00-19:00<br> Pole Dancing",
            thu: "25.04. Today<br><br> 20:30-21:30<br> Stretching",
            fri: "26.04.",
            sat: "27.04. <br><br> 11:00-14:00<br> Winter Kaffee",
            sun: "28.04. <br><br> 14:00-	&#8734; <br> Fotos machen"
        },
        {
            mon: "29.04. <br><br> 19:15-20:15 <br> Pole Dancing <br> 20:30-21:30 <br> Stretching",
            tue: "30.04. <br><br> 18:00 <br> Shopping TKMaxx",
            wed: "01.05. <br><br> 18:00-19:00 <br> Pole Dancing",
            thu: "02.04.",
            fri: "03.04. <br><br> 18:00- &#8734; <br> Meal Prep",
            sat: "04.04.",
            sun: "05.04."
        }
    ];
    ...
    for(var i = 0; i < cells.length; i++) {
        ...
        row.insertCell(0).innerHTML = cells[i].mon;
        row.insertCell(1).innerHTML = cells[i].tue;
        row.insertCell(2).innerHTML = cells[i].wed;
        row.insertCell(3).innerHTML = cells[i].thu;
        row.insertCell(4).innerHTML = cells[i].fri;
        row.insertCell(5).innerHTML = cells[i].sat;
        row.insertCell(6).innerHTML = cells[i].sun;
    }

    // Table Head
    var headers = ["<b>Monday</b>", "<b>Tuesday</b>", "<b>Wednesday</b>", "<b>Thursday</b>", "<b>Friday</b>", "<b>Saturday</b>", "<b>Sunday</b>"];
    var thead = table.createTHead();
    var theadr = thead.insertRow(0);
    for(var i = 0; i < headers.length; i++) {
        theadr.insertCell(i).innerHTML = headers[i];
    }
